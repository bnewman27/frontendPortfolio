        ...
        <form action="#" method="POST" className="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48 bg-sky-800">
          <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
            ...
            <div className="mt-8 flex justify-end">
              <button
                type="submit"
                className="rounded-full text-sky-200 bg-sky-950 px-3.5 py-2.5 text-center text-sm font-semibold  shadow-sm ring ring-sky-800 hover:bg-sky-800 hover:ring-sky-950 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-950"
              >
                Send message
              </button>
            </div>
