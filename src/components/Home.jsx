        ...
        <div className="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
          <div className="relative lg:col-start-2 lg:row-start-1">
            ...
            <div className="relative mx-auto max-w-prose text-base lg:max-w-none">
              <figure>
                <div className="bg-contain bg-sky-200                  ">
                  <img
                    className="object-fill bg-contain bg-profile shadow-dmbg shadow-lg rounded-lg"
          ...
          <div className=" text-left mt-8 lg:mt-0 block w-full rounded-md border-0 px-3.5 py-2 text-sky-200 bg-sky-800 shadow-lg shadow-dmbg ring-1 ring-inset ring-sky-600 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-800 sm:text-sm sm:leading-6">
