...
const GamePage = () => {
    return (
    <div className="grid grid-cols-3 bg-gradient-tr from-sky-900 via-sky-800 to-sky-950 font-puffinChrome drop-shadow-lg shadow-inner shadow-dmbg text-sky-400 text-center p-4">
